...
public class StreamExam {
	public static void main(String[] args) {
		String fileInputStream = "FileInputStream은 바이트 단위로 입력하기 위한 스트림";
		String bufferedInputStream = "BufferedInputStream은 바이트 단위로 입력하기 위한 스트림 : 메모리 버퍼로 로딩 후";
		String fileReader = "FileReader는 문자 단위로 입력하기 위한 스트림";
		String bufferedReader = "BufferedReader는 문자 단위로 입력하기 위한 스트림 : 메모리 버퍼로 로딩 후";
		
		String fileOutputStream = "FileOutputStream은 바이트 단위로 출력하기 위한 스트림";
		String bufferedOutputStream = "BufferedOutputStream은 바이트 단위로 출력하기 위한 스트림 : 메모리 버퍼로 로딩 후";
