package sec3;
//코드 인스펙션  => 성능 개선, 코드 작성 규칙 준수, 에러 발생 가능성 최소화하기 위한 작업
...
//Important		마젠타(자주)		Medium Low		(Mino) 소스코드의 가독성, 유지 보수성 향상을 위해 수정을 권고하는 위반 사항을 말한다.
//Warning		파랑				Low				(Info) 정보성으로 제공되는 위반사항으로 개발자가 참고하여 적용할 수 있다.
