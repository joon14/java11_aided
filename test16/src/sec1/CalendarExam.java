...
public class CalendarExam {
	public static void main(String[] args) {
		//날짜와 시간 분리 = Calendar
		Calendar today = Calendar.getInstance();		//싱글톤 	//Date today = new Date();
		...
		System.out.println("오늘은 "+month+"월의 "+dom+"번 째 날");
		System.out.println("오늘은 이번 주의 "+dow+"번 째 날");
		
		String wk[] = {"일요일","월요일","화요일","수요일","목요일","즐거운 금요일","토요일"};
